...
import { getPortfolioSnapshot, getPropBets, getAllProps, getPrizePicksBets } from "../../lib/store";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [propBets, allPropsList, ppBets, hasUpcomingGames] = await Promise.all([
      getPropBets(),
      getAllProps(),
      getPrizePicksBets(),
      checkUpcomingGames(),
